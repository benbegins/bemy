...
<div class="single-article">
    ...
    <section class="pt-20 lg:pt-0">
        <div class="container flex flex-col-reverse lg:flex-row lg:items-end">
            <div class="blog__portrait__wrapper">
                <img src="<?php echo get_template_directory_uri(); ?>/dist/images/benoit-tommy.png" alt="Tommy Bonneau / Benoit Beghyn" class="w-full h-full object-cover" />
            </div>
